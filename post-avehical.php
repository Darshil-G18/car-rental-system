...
<head>
	...
	<title>Go Car | Admin Post Vehicle</title>
...
<div class="col-sm-4">
  <input type="number" name="priceperday" class="form-control" required step="0.01" min="0" 
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    <input type="number" name="modelyear" class="form-control" required oninput="this.value = this.value.replace(/[^0-9]/g, '')" />
  </div>

  <label class="col-sm-2 control-label">Seating Capacity<span style="color:red">*</span></label>
  <div class="col-sm-4">
    <input type="number" name="seatingcapacity" class="form-control" required oninput="this.value = this.value.replace(/[^0-9]/g, '')" />
  </div>
</div>
<div class="hr-dashed"></div>
